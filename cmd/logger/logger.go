...
// and GOROOT directories. Also append github.com/storj/minio
...
func Init(goPath string, goRoot string) {
	...
	// Add "github.com/storj/minio" as the last to cover
	// paths like "{GOROOT}/src/github.com/storj/minio"
	// and "{GOPATH}/src/github.com/storj/minio"
